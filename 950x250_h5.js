...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/HG_950x250.png", id:"HG_950x250"}
	]
};
...
(lib.HG_950x250 = function() {
	this.initialize(img.HG_950x250);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,950,250);
...
// stage content:
(lib._950x250_h5 = function(mode,startPosition,loop) {
	...
	// HG
	this.instance_1 = new lib.HG_950x250();
...
p.nominalBounds = new cjs.Rectangle(150,125,950,250);
